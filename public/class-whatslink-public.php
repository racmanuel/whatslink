...
class Whatslink_Public {
	 ...
	 *
	 * Shortcode can take attributes like [whatslink-shortcode attribute='123']
	 * Shortcodes can be enclosing content [whatslink-shortcode attribute='123']custom content[/whatslink-shortcode].
	 *
	 ...
	 */
	public function whatslink_shortcode_func( $atts, $content = null, $tag ) {
