                ...
                <form>
                    <div class="row">
                        <div class="col-12">
                            ...
                            <input type="text" id="phone_region_code" class="form">
                            <span
                    ...
                    <div class="row">
                        <div class="col-12">
                            <button class="form full" type="button" id="generate-link">Generar Link</button>
                        </div>
                        <div class="col-12">
                            <button class="form success full" type="button" id="generate-qr">Generar QR</button>
                        </div>
                    </div>
                </form>
            </div>
